...
if(NOT "/home/justin/catkin_ws/src/offloadable_face_recognition/devel/include" STREQUAL "")
  set(offloadable_face_recognition_INCLUDE_DIRS "")
  set(_include_dirs "/home/justin/catkin_ws/src/offloadable_face_recognition/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'offloadable_face_recognition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/justin/catkin_ws/src/offloadable_face_recognition/${idir}'.  Ask the maintainer 'Justin McManus <jmcmanus1992@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/justin/catkin_ws/src/offloadable_face_recognition/devel/lib;/home/justin/catkin_ws/devel/lib;/opt/ros/indigo/lib)
